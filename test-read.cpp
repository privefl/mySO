...
// [[Rcpp::export]]
int readFile(const char * filename = "test_file.txt",
             char mode = 'c') {
  static const std::size_t filesize = 1024 * 1024 * 3;
...
library(microbenchmark)
  system.time(tmp <- readFile("filename.raw", 'm'))
  microbenchmark(
    readFile("../filename.raw", 'c'),
    readFile("../filename.raw", 'm'),
    readFile("../filename.raw", 'r'),
    readFile("../filename.raw", 'a'),
    times = 20
  )
  */
